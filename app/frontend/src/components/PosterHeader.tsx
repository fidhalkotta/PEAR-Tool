...
export default function PosterHeader() {
	return (
		<div className="bg-ucl_pink text-white w-full fixed top-0 left-0 flex items-center justify-between px-4">
			...
			<img src="/images/ucl_logo.png" alt="UCL Logo" className="h-24 pb-2"/>
		</div>
	);
}
